...
export default function About() {
  ...
  return (
    <div className="bg-black min-h-screen text-white pb-32">
      ...
      {/* Container Utama Warna Putih dengan Lengkungan di Bawah */}
      <div className="relative bg-white min-h-[90vh] rounded-b-[3rem] md:rounded-b-[5rem] flex flex-col justify-center overflow-hidden z-10 pb-20">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0 select-none">
          <h1 className={`${montserrat.className} text-[22vw] font-black text-gray-100 tracking-tighter`}>
            PROFILE
          </h1>
        </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-24 flex flex-col md:flex-row items-center md:items-start gap-12 lg:gap-24 pt-24 md:pt-0">
          ...
          <div className="w-full md:w-1/2 flex flex-col mt-4 md:mt-12">
            <h2 className={`${montserrat.className} text-6xl md:text-[5.5rem] lg:text-[7.5rem] font-black text-black leading-[0.85] tracking-tighter`}>
              I'm
            </h2>
            <h2 className={`${montserrat.className} text-7xl md:text-[6.5rem] lg:text-[9rem] font-black text-black leading-[0.85] tracking-tighter uppercase mt-2`}>
              THIFAH
            </h2>
            ...
            <div className="flex flex-wrap items-center gap-4 mt-10 md:mt-12">
              ...
              <a 
                ...
                className="bg-black text-white rounded-full px-6 py-3 md:px-8 md:py-4 flex items-center gap-3 w-fit hover:scale-105 transition-transform group shadow-lg"
              >
              ...
              <a 
                ...
                className="bg-white text-black border border-black rounded-full px-6 py-3 md:px-8 md:py-4 flex items-center gap-3 w-fit hover:bg-gray-100 hover:scale-105 transition-all group shadow-sm"
              >
          ...
          <div className="w-full md:w-1/2 flex items-center md:pt-16">
            <p className={`${montserrat.className} text-gray-800 font-normal text-base md:text-lg leading-loose md:leading-relaxed text-justify md:text-left`}>
              Hi there! You can call me <span className="font-bold text-black">Thifah</span>. I'm a final-year Information Systems undergraduate student at Institut Teknologi Sepuluh Nopember (ITS). I am dedicated to bridging the gap between technical execution and business strategy through Full-Stack Development, Strategic System Analysis, and Data Visualization. With a proven track record of engineering role-based enterprise solutions and translating operational data into high-level management insights, I aim to leverage my analytical problem-solving and programming skills to drive process optimization and support corporate decision-making.
            </p>
          </div>
      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-24 pt-24 md:pt-32">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end w-full mb-8">
          <div className="flex flex-col leading-[0.85]">
            <h2 className={`${montserrat.className} text-4xl md:text-6xl lg:text-7xl font-black text-white uppercase tracking-tighter`}>
              PROFESSIONAL
            </h2>
            <h2 className={`${montserrat.className} text-4xl md:text-6xl lg:text-7xl font-black text-gray-600 uppercase tracking-tighter`}>
              JOURNEY
            </h2>
          </div>
          <div className="mt-8 md:mt-0 text-left md:text-right">
            <p className={`${montserrat.className} text-xs md:text-sm tracking-[0.2em] text-gray-500 uppercase leading-relaxed`}>
        ...
        <hr className="border-gray-800/80 mb-8" />

        {/* EXPERIENCE CARD (HOVER UNTUK EXPAND) */}
        <div className="group py-6 md:py-8 border-b border-gray-800/80 hover:bg-[#0a0a0a] transition-colors duration-300 rounded-xl px-4 md:px-6 -mx-4 md:-mx-6 cursor-default">
          
          {/* Bagian Header Card (Selalu Terlihat) */}
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-8">
            
            {/* Tanggal */}
            <div className="w-full md:w-2/12 text-xs md:text-sm font-mono text-gray-500 group-hover:text-gray-400 transition-colors">
              Jul – Dec 2025
            </div>
            
            {/* Posisi/Role */}
            <div className="w-full md:w-6/12">
              <h3 className={`${montserrat.className} text-3xl md:text-5xl font-bold text-white tracking-tight`}>
                IT Intern
              </h3>
            </div>
            
            {/* Perusahaan & Tombol Plus/Silang */}
            <div className="w-full md:w-4/12 flex items-center justify-between md:justify-end gap-6 text-gray-500 group-hover:text-gray-300 transition-colors flex-shrink-0">
          ...
          <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-in-out">
            <div className="overflow-hidden">
              {/* Teks sejajar dari ujung kiri sampai ujung kanan */}
              <div className="pt-8 md:pt-10 flex flex-col gap-8 w-full">
                
                {/* Teks Paragraf Pengalaman (Lebar penuh) */}
                <p className="text-gray-400 text-sm md:text-base leading-relaxed text-justify md:text-left w-full">
                ...
                {/* Tags ditaruh lurus di bawah paragraf */}
                <div className="flex flex-wrap items-center gap-3">
                  <span className="px-5 py-2 rounded-full border border-gray-700 text-[10px] md:text-xs text-gray-400 font-mono group-hover:border-gray-500 group-hover:text-gray-300 transition-colors">LARAVEL</span>
                  <span className="px-5 py-2 rounded-full border border-gray-700 text-[10px] md:text-xs text-gray-400 font-mono group-hover:border-gray-500 group-hover:text-gray-300 transition-colors">PHP</span>
                  <span className="px-5 py-2 rounded-full border border-gray-700 text-[10px] md:text-xs text-gray-400 font-mono group-hover:border-gray-500 group-hover:text-gray-300 transition-colors">MYSQL</span>
                </div>
      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-24 pt-24 md:pt-32">
        ...
        <div className="group border border-white/10 rounded-2xl p-6 md:p-10 hover:bg-white transition-colors duration-500 ease-in-out cursor-default relative overflow-hidden bg-[#050505]">
          
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            
            {/* Bagian Kiri: Tahun dan Institusi */}
            <div className="flex flex-col gap-2">
              <span className="font-mono text-xs md:text-sm text-gray-500 group-hover:text-gray-800 transition-colors duration-500 tracking-[0.15em] font-bold uppercase whitespace-nowrap">
                Jun 2022 - Aug 2026 (Expected)
              </span>
              <h3 className={`${montserrat.className} text-2xl md:text-3xl lg:text-4xl font-black text-white group-hover:text-black transition-colors duration-500 uppercase tracking-tighter mt-1`}>
                Institut Teknologi Sepuluh Nopember
              </h3>
            </div>
            
            {/* Bagian Kanan: Jurusan - Ditambahkan whitespace-nowrap dan flex-shrink-0 */}
            <div className="mt-2 md:mt-0 md:text-right flex-shrink-0">
              <span className={`${montserrat.className} text-lg md:text-xl font-medium text-gray-300 group-hover:text-black transition-colors duration-500 whitespace-nowrap`}>
                Information Systems
              </span>
            </div>
      ...
      <button 
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 w-12 h-12 md:w-14 md:h-14 bg-white text-black rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg z-40"
